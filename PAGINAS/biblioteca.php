...
$id_cliente = mysqli_real_escape_string($conexao, $_SESSION["id"]);
...
<nav id="menu" class="menu">
    ...
    <ul>
        ...
        <?php if ($tipo === "admin") { ?>
            ...
            <li>
                <a href="../XAMP/consulta.php">Consulta</a>
            </li>

            <li>
                <a href="../PAGINAS/cadastroEmpresa.php">Cadastro de Empresa</a>
            </li>

            <li>
                <a href="cadastroJogos.php">Cadastro de Jogos</a>
            </li>
...
<main class="biblioteca">
    ...
    <section class="recentes">
        ...
        <div class="lista-recentes">
            ...
            $resultado_recente = mysqli_query($conexao, $sql_recente);

            if (!$resultado_recente) {

                echo "<p>Erro ao buscar o jogo recente.</p>";

            } elseif (mysqli_num_rows($resultado_recente) > 0) {

                $recente = mysqli_fetch_assoc($resultado_recente);
